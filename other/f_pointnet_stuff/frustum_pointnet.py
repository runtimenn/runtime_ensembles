...
class FrustumPointNet(nn.Module):
    ...
    def forward(self, x):
        ...
        patt_boxnet = self.BboxNet_network.intermed(seg_point_clouds)
        ...
        return (out_InstanceSeg, out_TNet, out_BboxNet, out_seg_point_clouds_mean, out_dont_care_mask), patt_boxnet
